...
import heroImage from '../images/blerta.png';

const Hero = () => {
  return (
    <section className="w-full min-h-[88vh] bg-[rgb(10,0,27)] border-b-[10px] border-[rgb(43,105,251)] flex flex-col lg:flex-row justify-center items-center p-8 relative rounded-b-[100px]">
      <div className="w-full max-w-[1200px] mx-auto px-8 flex flex-col lg:flex-row items-center justify-between gap-8 relative z-10">
        ...
        <div className="relative w-[300px] h-[300px] lg:w-[400px] flex items-center justify-center">
          ...
          <div className="relative w-full h-full rounded-full overflow-hidden border-4 border-[rgb(202, 208, 224)] shadow-[0_0_30px_rgba(43,105,251,0.5)]">
            <img 
              src={heroImage} 
              alt="Blerta Aliu" 
